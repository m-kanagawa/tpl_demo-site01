<section class="news-box">
	...
	<div class="news-box__inner">
		<ul class="news-box__tab">
			...
			<li class="tab">Menu1</li>
			<li class="tab">Menu2</li>
			<li class="tab">Menu3</li>
		</ul>
		...
		<div class="news-box__panel">
			...
			<div class="panel">
				...
				<dl>
					...
					<dt><?php echo get_the_date(); ?></dt>
					<dd><a href="<?php echo home_url(); ?>/category/news/" class="cat news">News</a><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></dd>
					<?php endforeach; ?>
			...
			<div class="panel">
				...
				<dl>
					<?php foreach ( $posts as $post ) : setup_postdata( $post ); ?>
					<dt><?php echo get_the_date(); ?></dt>
					<dd><a href="<?php echo home_url(); ?>/category/event/" class="cat event">Event</a><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></dd>
					<?php endforeach; ?>
					<?php endif; wp_reset_postdata(); ?>
				</dl>
			</div><!-- ./panel -->
			...
			<div class="panel">
				...
				<dl>
					<?php foreach ( $posts as $post ) : setup_postdata( $post ); ?>
					<dt><?php echo get_the_date(); ?></dt>
					<dd><a href="<?php echo home_url(); ?>/category/event/" class="cat menu1">Menu1</a><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></dd>
					<?php endforeach; ?>
					<?php endif; wp_reset_postdata(); ?>
				</dl>
			</div><!-- ./panel -->
			...
			<div class="panel">
				...
				<dl>
					<?php foreach ( $posts as $post ) : setup_postdata( $post ); ?>
					<dt><?php echo get_the_date(); ?></dt>
					<dd><a href="<?php echo home_url(); ?>/category/event/" class="cat menu2">Menu2</a><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></dd>
					<?php endforeach; ?>
					<?php endif; wp_reset_postdata(); ?>
				</dl>
			</div><!-- ./panel -->
			...
			<div class="panel">
				...
				<dl>
					<?php foreach ( $posts as $post ) : setup_postdata( $post ); ?>
					<dt><?php echo get_the_date(); ?></dt>
					<dd><a href="<?php echo home_url(); ?>/category/event/" class="cat menu3">Menu3</a><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></dd>
					<?php endforeach; ?>
					<?php endif; wp_reset_postdata(); ?>
				</dl>
			</div><!-- ./panel -->
